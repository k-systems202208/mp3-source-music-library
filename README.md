...
開発・受入環境では、次の状態でv2.7.6を確認しました。これは製品の固定上限ではなく、確認に使用したライブラリの実績値です。
...
- v2.7.6の全ソース回帰試験、EXEスモーク試験、Inno Setupコンパイルに合格
...
1. GitHub Releasesから`MusicLibrary-Setup-2.7.6-x64.exe`を取得します。
...
- [v2.7.6リリース監査結果](docs/20-release-audit-v2.7.6.md)

Windows配布物に同梱する文書は[インストーラー文書一覧](windows-installer/docs/DOCUMENT_INDEX_v2.7.6.md)を参照してください。
